...
export const article: BlogArticle = {
  slug: "eviter-arnaques-voiture-occasion",
  title: "Éviter les arnaques à la voiture d'occasion : 10 signaux d'alerte",
  description:
    "Comment repérer une arnaque à la voiture d'occasion : kilométrage trafiqué, faux contrôle technique, vente forcée. Le guide pour acheter en sécurité.",
  publishedAt: "2026-05-02",
  updatedAt: "2026-05-02",
  category: "Véhicules",
  keywords: [
    "arnaque voiture occasion",
    "éviter arnaque voiture",
    "kilométrage trafiqué",
    "faux contrôle technique",
    "vérifier voiture occasion",
    "achat voiture occasion sécurisé",
    "signaux alerte voiture",
  ],
  ...
  sections: [
    {
      h2: "Signal n°1 : annonce trop belle pour être vraie",
      paragraphs: [
    ...
    {
      h2: "Signal n°2 : pression sur le timing",
      paragraphs: [
    ...
    {
      h2: "Signal n°3 : kilométrage suspect ou incohérent",
      paragraphs: [
    ...
    {
      h2: "Signal n°4 : faux contrôle technique",
      paragraphs: [
    ...
    {
      h2: "Signal n°5 : paiement non sécurisé exigé",
      paragraphs: [
    ...
    {
      h2: "Signal n°6 : véhicule importé sans documents complets",
      paragraphs: [
    ...
    {
      h2: "Signal n°7 : refus d'inspection mécanique pré-achat",
      paragraphs: [
    ...
    {
      h2: "Signal n°8 : carte grise incomplète ou suspecte",
      paragraphs: [
    ...
    {
      h2: "Signal n°9 : vendeur indisponible pour les vérifications",
      paragraphs: [
    ...
    {
      h2: "Signal n°10 : pression émotionnelle ou personnelle",
      paragraphs: [
  ...
  faq: [
    {
      q: "Comment vérifier qu'une voiture d'occasion n'a pas été volée ?",
      a: "Utilisez le service Histovec (gratuit, gouvernemental) avec le numéro d'immatriculation et le numéro de formule de la carte grise. Histovec vous indique si le véhicule est déclaré volé, gagé, ou s'il a fait l'objet d'un sinistre déclaré.",
    },
    {
      q: "Comment détecter un kilométrage trafiqué ?",
      a: "Croisez le kilométrage affiché avec celui inscrit sur les factures d'entretien, le carnet d'entretien, le dernier contrôle technique, et l'historique Histovec. L'usure des éléments d'usage (volant, levier, pédales, sellerie) doit également correspondre au kilométrage déclaré.",
    },
    {
      q: "Quel moyen de paiement utiliser pour une voiture d'occasion ?",
      a: "Le virement instantané reçu sur votre compte avant remise des clés est le moyen le plus sûr. Le chèque de banque est valable uniquement après vérification physique téléphonique avec l'agence émettrice. L'argent liquide est plafonné à 1 000 € légalement.",
    },
    {
      q: "Faut-il faire inspecter une voiture avant l'achat ?",
      a: "Oui, dans la quasi-totalité des cas. Une inspection mécanique pré-achat coûte 150 à 300 € et permet d'éviter des découvertes coûteuses après l'achat. C'est aussi un argument de négociation puissant.",
    },
    {
      q: "Que faire si je découvre une arnaque après l'achat ?",
      a: "Déposer une plainte au commissariat ou en gendarmerie dans les 48 heures. Contacter votre banque pour bloquer un éventuel virement en attente. Pour les véhicules : signaler le numéro d'immatriculation via la plateforme ANTS si vous constatez une fraude documentaire.",
    },
    {
      q: "Peut-on annuler une vente entre particuliers ?",
      a: "Oui en cas de vice caché prouvé (article 1641 du Code civil). Vous disposez de 2 ans à compter de la découverte du vice pour engager une action en résolution de la vente. Le défaut doit être grave, antérieur à la vente, et inconnu au moment de l'achat.",
    },
    {
      q: "Combien de vérifications minimales avant d'acheter ?",
      a: "Cinq étapes minimum : (1) Histovec gratuit, (2) inspection mécanique pré-achat, (3) essai sur parcours mixte de 20 minutes, (4) vérification croisée des documents, (5) inspection visuelle approfondie avec vérification du numéro de série moteur et VIN.",
    },
  ],
};
