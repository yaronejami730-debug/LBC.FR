...
export const article: BlogArticle = {
  slug: "reglementation-trottinette-electrique-2026",
  ...
  keywords: [
    ...
    "amende trottinette électrique",
    "assurance trottinette obligatoire",
    "casque trottinette obligatoire",
    "âge minimum trottinette",
  ],
  ...
  sections: [
    {
      h2: "Le cadre légal général en 2026",
      paragraphs: [
    ...
    {
      h2: "Vitesse maximale et sanctions",
      paragraphs: [
    ...
    {
      h2: "Assurance obligatoire : ce qu'il faut savoir",
      paragraphs: [
    ...
    {
      h2: "Âge minimum et obligations pour les jeunes",
      paragraphs: [
    ...
    {
      h2: "Où circuler : voies autorisées et interdites",
      paragraphs: [
    ...
    {
      h2: "Équipement obligatoire et fortement recommandé",
      paragraphs: [
    ...
    {
      h2: "Tableau des principales sanctions",
      paragraphs: [
  ...
  faq: [
    {
      q: "Faut-il une assurance pour rouler en trottinette électrique en 2026 ?",
      a: "Oui, l'assurance responsabilité civile est obligatoire depuis 2019 pour toute trottinette circulant sur voie publique, y compris bridée. Le défaut d'assurance est puni d'une amende de 500 € et engage la responsabilité personnelle du conducteur en cas d'accident.",
    },
    {
      q: "Quelle est la vitesse maximale autorisée ?",
      a: "25 km/h sur voie publique en France. Dépasser cette vitesse expose à une amende pouvant atteindre 1 500 € et à la confiscation du véhicule. Le débridage n'est légal que sur terrain privé.",
    },
    {
      q: "À partir de quel âge peut-on conduire une trottinette électrique ?",
      a: "14 ans depuis juillet 2023 (contre 12 ans précédemment). Pour les moins de 12 ans, le casque est obligatoire et la conduite reste interdite sur voie publique.",
    },
    {
      q: "Le casque est-il obligatoire ?",
      a: "Obligatoire uniquement pour les moins de 12 ans. Au-delà, il est fortement recommandé mais non imposé par la loi, sauf prescription municipale spécifique dans certaines villes.",
    },
    {
      q: "Peut-on rouler sur le trottoir ?",
      a: "Non, la circulation sur trottoir est strictement interdite et sanctionnée d'une amende de 135 €. Seule la trottinette poussée moteur coupé est tolérée.",
    },
    {
      q: "Peut-on transporter un passager ?",
      a: "Non, le transport de passager est strictement interdit sur trottinette électrique. L'infraction est punie de 135 € sans aucune exception possible.",
    },
    {
      q: "Faut-il un permis pour rouler en trottinette électrique ?",
      a: "Non, aucun permis n'est requis pour une trottinette homologuée 25 km/h. L'absence de permis n'exonère cependant pas des obligations d'assurance et d'âge minimum.",
    },
    {
      q: "Que risque-t-on à débrider sa trottinette ?",
      a: "Amende jusqu'à 1 500 €, confiscation du véhicule, perte de garantie constructeur et nullité du contrat d'assurance. La responsabilité civile en cas d'accident sur trottinette débridée n'est jamais couverte.",
    },
  ],
};
