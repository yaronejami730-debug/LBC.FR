...
export const article: BlogArticle = {
  slug: "acheter-moto-occasion-checklist",
  title: "Acheter une moto d'occasion : checklist complète 2026",
  description:
    "Checklist complète pour acheter une moto d'occasion : 30 vérifications mécaniques et administratives. Le guide pro pour éviter les pièges.",
  publishedAt: "2026-04-29",
  updatedAt: "2026-04-29",
  category: "Véhicules",
  keywords: [
    "acheter moto occasion",
    "checklist moto occasion",
    "vérifications moto occasion",
    "inspection moto avant achat",
    "essai moto occasion",
    "moto occasion conseils",
  ],
  ...
  sections: [
    {
      h2: "Vérifications administratives essentielles",
      paragraphs: [
    ...
    {
      h2: "Inspection du cadre et de la carrosserie",
      paragraphs: [
    ...
    {
      h2: "Inspection mécanique : moteur et transmission",
      paragraphs: [
    ...
    {
      h2: "Inspection des suspensions et freins",
      paragraphs: [
    ...
    {
      h2: "Inspection des pneus, des roues et de l'électronique",
      paragraphs: [
    ...
    {
      h2: "Essai routier et négociation",
      paragraphs: [
  ...
  faq: [
    {
      q: "Comment vérifier qu'une moto d'occasion n'a pas chuté ?",
      a: "Examiner les commodos, leviers, repose-pieds, rétroviseurs, échappement et carénages. Des éléments neufs sur une moto ancienne, des rayures sur les protections moteur ou des leviers récents trahissent presque toujours une chute non déclarée.",
    },
    {
      q: "Faut-il une inspection mécanique avant l'achat ?",
      a: "Idéalement oui. Une inspection chez un concessionnaire ou un mécanicien indépendant coûte 80 à 150 €. Pour une moto à plus de 4 000 €, c'est un investissement très rentable qui peut éviter plusieurs milliers d'euros de réparations cachées.",
    },
    {
      q: "À quel kilométrage faut-il s'inquiéter sur une moto d'occasion ?",
      a: "Au-delà de 50 000 km, prévoir un budget de remise en état (chaîne, pneus, plaquettes, suspensions). Au-delà de 80 000 km, l'embrayage et certains éléments moteur peuvent nécessiter une révision lourde. Sous 30 000 km, la moto est généralement saine.",
    },
    {
      q: "Le contrôle technique moto est-il obligatoire en 2026 ?",
      a: "Oui, depuis avril 2024 pour les motos de plus de 5 ans. Tous les 3 ans pour les motos de tourisme, plus fréquent pour les motos modifiées. Le PV doit dater de moins de 6 mois à la cession.",
    },
    {
      q: "Que faire si la moto a un défaut technique caché après l'achat ?",
      a: "Engager une action en vice caché (article 1641 du Code civil) dans les 2 ans à compter de la découverte du défaut. Le défaut doit être grave, antérieur à la vente et inconnu de l'acheteur. Réunir factures, expertises et témoignages pour appuyer la demande.",
    },
    {
      q: "Peut-on acheter une moto d'occasion sans la voir ?",
      a: "Fortement déconseillé. Aucune photo ne remplace un essai physique. Les arnaques par vente à distance (paiement avant livraison via transporteur) sont nombreuses. Toujours se déplacer pour voir, essayer et inspecter avant tout paiement.",
    },
    {
      q: "Quels documents demander avant le paiement ?",
      a: "Carte grise originale au nom du vendeur, dernier contrôle technique (moins de 6 mois si applicable), carnet d'entretien complet, factures de révisions, attestation d'assurance temporaire pour l'essai, certificat de cession à pré-remplir ensemble.",
    },
  ],
};
