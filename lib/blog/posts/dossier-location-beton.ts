...
export const article: BlogArticle = {
  slug: "dossier-location-beton",
  title: "Dossier de location béton : 10 astuces qui marchent en 2026",
  description:
    "Comment monter un dossier de location qui plaît aux propriétaires : pièces à fournir, présentation, garant, conseils pratiques pour louer vite.",
  ...
  sections: [
    {
      h2: "Les pièces obligatoires d'un dossier de location",
      paragraphs: [
    ...
    {
      h2: "Astuce n°1 : utiliser DossierFacile",
      paragraphs: [
    ...
    {
      h2: "Astuce n°2 : présenter un dossier numérique structuré",
      paragraphs: [
    ...
    {
      h2: "Astuce n°3 : la page de garde de présentation",
      paragraphs: [
    ...
    {
      h2: "Astuce n°4 : trouver un garant solide",
      paragraphs: [
    ...
    {
      h2: "Astuce n°5 : optimiser sa présentation aux visites",
      paragraphs: [
    ...
    {
      h2: "Astuce n°6 : suivre les candidatures par email",
      paragraphs: [
    ...
    {
      h2: "Astuce n°7 : élargir géographiquement et techniquement",
      paragraphs: [
    ...
    {
      h2: "Astuce n°8 : éviter les erreurs qui éliminent",
      paragraphs: [
  ...
  faq: [
    {
      q: "Quels documents faut-il pour un dossier de location ?",
      a: "Carte d'identité, justificatif de domicile, contrat de travail, trois derniers bulletins de salaire, deux derniers avis d'imposition, trois dernières quittances de loyer, RIB. La liste est limitative selon la loi ALUR, aucun document supplémentaire ne peut être exigé.",
    },
    {
      q: "Qu'est-ce que DossierFacile et est-ce gratuit ?",
      a: "DossierFacile.fr est un service public gratuit qui permet de constituer un dossier de location certifié par l'État. Les pièces sont vérifiées et labellisées. Les candidatures DossierFacile sont retenues 2,3 fois plus souvent que les dossiers classiques selon les statistiques 2024-2025.",
    },
    {
      q: "Quel revenu faut-il pour louer un appartement ?",
      a: "Idéalement 3 fois le loyer charges comprises. Pour un loyer de 800 €, viser 2 400 € de revenus nets mensuels. En dessous de 2,8 fois le loyer, un garant solide ou une assurance loyer impayé devient nécessaire.",
    },
    {
      q: "Comment obtenir la garantie Visale ?",
      a: "Sur visale.fr, gratuitement, sous conditions (moins de 30 ans, ou mutation professionnelle, ou jeune en CDD/intérim). La procédure prend 5 minutes en ligne et délivre un visa officiel à présenter aux propriétaires. Acceptée par 95 % des propriétaires en 2026.",
    },
    {
      q: "Faut-il avoir un garant pour louer ?",
      a: "Pas obligatoirement si vos revenus représentent 3 à 4 fois le loyer. Pour des revenus inférieurs ou un profil atypique (étudiant, indépendant, étranger), un garant solide ou une garantie Visale facilite grandement l'acceptation.",
    },
    {
      q: "Comment se démarquer dans un marché tendu ?",
      a: "Dossier complet DossierFacile, page de garde de présentation, suivi par email après visite, flexibilité géographique et technique, candidature dans les 2 heures suivant la publication de l'annonce. La rapidité est aussi importante que la qualité du dossier.",
    },
    {
      q: "Combien de temps un propriétaire prend-il pour répondre ?",
      a: "Entre 24 heures et 7 jours en moyenne. Une absence de réponse au-delà de 7 jours signale généralement une autre candidature retenue. Ne pas insister, concentrer ses efforts sur d'autres biens.",
    },
  ],
};
