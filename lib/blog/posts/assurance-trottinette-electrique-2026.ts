...
export const article: BlogArticle = {
  slug: "assurance-trottinette-electrique-2026",
  title: "Assurance trottinette électrique 2026 : prix et comparatif",
  description:
    "Assurance trottinette électrique obligatoire en 2026 : prix, garanties, comparatif des meilleures offres. Guide complet pour bien s'assurer.",
  ...
  keywords: [
    ...
    "prix assurance trottinette",
    "comparatif assurance trottinette",
    "assurance trottinette pas chère",
    "responsabilité civile trottinette",
  ],
  ...
  sections: [
    {
      h2: "Pourquoi l'assurance est obligatoire en 2026",
      paragraphs: [
    ...
    {
      h2: "Comparatif des principales offres en 2026",
      paragraphs: [
  ...
  faq: [
    {
      q: "L'assurance trottinette électrique est-elle vraiment obligatoire ?",
      a: "Oui, depuis le décret du 23 octobre 2019. La responsabilité civile est obligatoire pour toute trottinette électrique circulant sur voie publique, y compris bridée à 25 km/h. Le défaut d'assurance est sanctionné de 500 € d'amende.",
    },
    {
      q: "Combien coûte une assurance trottinette en 2026 ?",
      a: "Entre 5 et 12 €/mois pour la RC seule, entre 10 et 20 €/mois pour une formule complète incluant vol et dommages. Le tarif dépend de la valeur de la trottinette, du lieu de résidence et des garanties choisies.",
    },
    {
      q: "Mon assurance habitation couvre-t-elle ma trottinette ?",
      a: "Très rarement. Sauf extension spécifique souscrite et payante, l'assurance habitation classique ne couvre pas la conduite d'une trottinette électrique sur voie publique. Une assurance dédiée reste nécessaire.",
    },
    {
      q: "Que couvre la responsabilité civile trottinette ?",
      a: "La RC couvre uniquement les dommages causés à autrui : piétons, cyclistes, automobilistes, biens matériels endommagés. Elle ne couvre jamais le conducteur lui-même ni la trottinette elle-même.",
    },
    {
      q: "Faut-il assurer une trottinette d'occasion ?",
      a: "Oui, exactement comme une trottinette neuve. L'obligation d'assurance s'applique dès le premier mètre sur voie publique, indépendamment de la date d'achat ou du mode d'acquisition.",
    },
    {
      q: "Que se passe-t-il en cas d'accident sans assurance ?",
      a: "L'utilisateur supporte personnellement tous les dommages causés à autrui, sans plafond. Un piéton renversé avec séquelles peut entraîner 200 000 à 800 000 € de dommages-intérêts, exécutoires à vie sur les biens et revenus.",
    },
    {
      q: "Peut-on assurer une trottinette débridée ?",
      a: "Non pour un usage public. Aucune assurance ne couvre une trottinette dépassant 25 km/h sur voie publique. Le débridage n'est légal que sur terrain privé, où une assurance dédiée peut s'appliquer selon les contrats.",
    },
  ],
};
