...
const navItems = [
  ...
  { href: "/admin/verifications-pro", icon: "verified_user", label: "Vérifications pro", exact: false },
  { href: "/admin/professionnels", icon: "storefront", label: "Professionnels", exact: false },
